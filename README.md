...
> A curated list of surveys, tutorials, codebases, and papers on **Reinforcement Learning with Verifiable Rewards (RLVR)** — an emerging paradigm that aligns LLMs through external verification, self-consistency, bootstrapped improvement, and more.
...
| [**OpenRLHF**](https://github.com/OpenRLHF/OpenRLHF) | Fully open reproduction of the DeepSeek-R1 pipeline (SFT → GRPO → evaluation). |
